...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        UIFunctions.report(self, "SELECT * FROM Chain_art")
        ...
        # self.ui.pushButton_3.clicked.connect(lambda: self.setDisabled(True)) ## 파싱 하는 동안 메인 윈도우 정지, 분석이 끝나면 enable 해야함, progressbar 필요
        #
        # # PAGE 4
